...
ps aux --sort=-%mem | awk '{print $1, $2, $3, $4, $5}' | head -n 6 > process.log
echo "Showing the process.log file: \n
 $(cat process.log)"
...
echo "Hi I'm $(whoami), logged into the machine $(hostname -I) at $(date), have observations listed, 

Contents of process.log are below:
$(cat /home/saran/process-parent/process.log) " > userinfo.txt
